...
public class ConsumerDemo {
    public static void main(String[] args) {
        ...
        stringStringKafkaConsumer.subscribe(Collections.singletonList("first_topic"));

        //poll for new data
        while (true) {
            ConsumerRecords<String, String> poll = stringStringKafkaConsumer.poll(Duration.ofMillis(100));
